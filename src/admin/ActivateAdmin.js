...
export class ActivateAdmin extends Component {
    constructor(props) {
        super(props);
        this.state = {
            id: this.props.match.params.id,
        ...
        return (
            <>
                ...
                <div style={divStyle}>
                    ...
                    <h3 style={{ color: '#00aff0' }}>{this.state.message ? this.state.message : "Click on link below to access your account"}</h3>
                    <Link style={{ color: '#00aff0', marginTop: '50px', fontSize: '25px' }} to='/admin/login'>Log in</Link>
                </div>
            </>
        )
    }
